...
#define STRING_CONFIG_H_AUTHOR "AlexKopitsa" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 416.4 }
...
#define Z_HOMING_HEIGHT  7.3      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

// #define Z_AFTER_HOMING  2.3      // (mm) Height to move to after homing Z
...
#define PREHEAT_1_TEMP_HOTEND 265
